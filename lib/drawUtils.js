...
export class DrawUtils {
    ...
    DrawShape(Shape={TYPE:"Point",X:0,Y:0},color="#fff",drawingHathDonBeenethCalled=ctx){
        if(Shape.TYPE=="Point"){
            this.Circle(Shape.X,Shape.Y,5,color,drawingHathDonBeenethCalled)
        }
        if(Shape.TYPE=="Circ"){
            this.Circle(Shape.X,Shape.Y,Shape.R,color,drawingHathDonBeenethCalled)
        }
        if(Shape.TYPE=="Rect"){
            this.Rect(Shape.X,Shape.Y,Shape.W,Shape.H,color,drawingHathDonBeenethCalled)
        }
    }
